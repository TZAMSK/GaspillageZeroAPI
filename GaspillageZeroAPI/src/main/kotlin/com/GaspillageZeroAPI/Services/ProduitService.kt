...
class ProduitService(val dao: ProduitDAO) {
    ...
    fun ajouter(produit: Produit): Boolean { return dao.ajouter(produit) != null }
    fun supprimer(idProduit: Int): Boolean { return dao.supprimer(idProduit) != null }
    fun modifier(idProduit: Int, produit: Produit): Boolean { return dao.modifier(idProduit, produit) != null }
}
